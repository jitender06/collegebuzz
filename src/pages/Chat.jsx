            ...
            <div className="flex flex-row h-full w-full">
                <div className="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
                    ...
                    >
                        ...
                        <div className="text-sm font-semibold mt-2">{currentLogin?.name ? currentLogin?.name : "jitender"}</div>
                        <div className="text-xs text-gray-500 text-center">{currentLogin?.address ? currentLogin?.address : "145001-xyz"}</div>
