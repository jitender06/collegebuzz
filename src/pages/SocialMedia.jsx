...
export default function SocialMedia({Posts, setActive, currentLogin }) {
    return (
        // < !--component -- >
        // <div className="app bg-gray-100">
        //     <main className="grid grid-cols-1 lg:grid-cols-2 gap-6 py-12 w-2xl container px-2 mx-auto">
        //         <aside>
        //             <div className="bg-white shadow rounded-lg p-10">
        //                 <Link to={"/message"}>
        //                     <MarkUnreadChatAltIcon sx={{ fontSize: 50, color: 'rgb(37 99 235)' }}/>
        //                 </Link>
        ...
        //                     <p className="font-semibold">{currentLogin?.name ? currentLogin?.name : "Jitender"}</p>
        ...
        //                         {currentLogin?.address ? currentLogin?.address : "145001-xyz"}
        //                     </div>
        //                 </div>
        ...
        //                 <div className="relative flex flex-col justify-between   bg-white rounded-3xl  bg-cover text-gray-800  overflow-hidden cursor-pointer w-full object-cover object-center rounded shadow-md h-64 my-2" style={{ backgroundImage: "url('https://images.unsplash.com/reserve/8T8J12VQxyqCiQFGa2ct_bahamas-atlantis.jpg?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1050&amp;q=80')" }}>
