...
function DashboardCard11() {
  ...
  const chartData = {
    ...
    datasets: [
      {
        label: 'Interaction with college events',
        data: [131],
      ...
      {
        label: 'College buzz features I need',
        data: [100],
      ...
      {
        label: 'Satisfied about the quality of the application',
        data: [81],
      ...
      {
        label: 'The application looks amazing',
        data: [65],
  ...
  return (
    <div className="col-span-full xl:col-span-6 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
      <header className="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
        <h2 className="font-semibold text-slate-800 dark:text-slate-100">Reason for Join</h2>
      </header>
