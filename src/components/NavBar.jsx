...
export default function NavBar({isLogin, setIsLogin, active, setActive}) {
  ...
  const navigation = isLogin ? [
    ...
    { name: 'Home', href: '/', current: active === "Home" ? true : false},
    { name: 'Login', href: '/login', current: active === "Login" ? true : false },
    { name: 'Signup', href: '/register', current: active === "Signup" ? true : false },
  ]
        ...
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-[4.5rem] items-center justify-between">
              ...
              <div className={`flex flex-1 items-center ${isLogin ? "justify-center": "justify-end"} sm:items-stretch sm:justify-start`}>
                <div className="flex flex-shrink-0 items-center scale-150">
                  <img
                      ...
                      <Menu as="div" className="relative ml-3">
                        <div>
                          <Menu.Button className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                            ...
                            <AccountCircleIcon sx={{color:"white", fontSize:33}}/>
                            {/* <img
